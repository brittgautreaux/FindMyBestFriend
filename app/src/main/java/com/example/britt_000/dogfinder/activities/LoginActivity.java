...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void initViews(){
        ...
        textInputEditTextEmail = (TextInputEditText) findViewById(R.id.emailText);
        textInputEditTextPassword = (TextInputEditText) findViewById(R.id.passwordText);
        appCompatButtonLogin = (AppCompatButton) findViewById(R.id.appCompatButtonLogin);
        textViewLinkRegister = (AppCompatTextView) findViewById(R.id.appCompatTextViewRegister);
    ...
    public void onClick(View v){
        switch(v.getId()){
            case R.id.appCompatButtonLogin:
                verifyFromSQLite();
                break;
            case R.id.appCompatTextViewRegister:
